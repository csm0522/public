		...
		<div id="logReg">
			...
			<div class="LoginMain">
				<form action="<?php echo U('User/login');?>" onsubmit="return submit_login()" method="post">
					<input type="text" value="" id="login_un" name="login_un" placeholder="用户名" required="required" onblur="check_login(this)" />
					<input type="password" id="login_pwd" value=""  name="login_pwd" placeholder="密码" required="required"  onblur="check_login_pwd(this)" />
					<div>
