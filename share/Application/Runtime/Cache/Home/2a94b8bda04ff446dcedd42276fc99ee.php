							...
							<div class="a-title">
								<div class="a-info">
									...
									<div class="works-info">
										...
										<span>人气:</span><span class="works-like"><?php echo ($vo["clicknum"]); ?> &nbsp;</span>
										<span class="works-like"><img src="/share/Public/Home/image/index/love.png" alt="" />&nbsp;<?php echo ($vo["num"]); ?> &nbsp;</span>
									</div>
								</div>
							</div>
