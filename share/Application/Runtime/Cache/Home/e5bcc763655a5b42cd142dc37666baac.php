 ...
 if($userInfo['username'] == '') { echo('昵称'); } else{ echo $userInfo[username]; } ?>
					...
					<div class="c_box">
						...
						<div class="c_title">
							...
							<div class="t_1" id="title4" onclick="show(4)">
								<input type="button" class="c_btn" value="<?php echo ($counts['concern']); ?>" />
								<h class="c_text" id="title4">关注</h>
							</div>

							<div class="t_1" id="title5" onclick="show(5)">
								<input type="button" class="c_btn" value="<?php echo ($counts['beconcern']); ?>" />
	    ...
	    <div class="artcle">
			<div class="artical-info">
				<ul>
					<?php if(is_array($userArt)): $i = 0; $__LIST__ = $userArt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="display: inline-block;">
						<a href="/share/index.php/Home/essay/essay/id/<?php echo ($vo["ariticalid"]); ?>" class="userAImg"><img src="/share/Public/<?php echo ($vo["indeximgpath"]); ?>" alt="" width="100%" height="300px;"/></a>
						<div class="userAInfo">
							<div class="userATitle">
									<a href="/share/index.php/Home/essay/essay/id/<?php echo ($vo["ariticalid"]); ?>"><?php echo (htmlspecialchars_decode($vo["title"])); ?></a>
							</div>
							<div  class="sortCo" style="display: inline-block;">
							...
							<div class="userAupTime" style="display: inline-block;"><span class="userA_Name"><?php echo ($vo["username"]); ?></span> /<?php echo (substr($vo["createtime"],0,10)); ?></div>
