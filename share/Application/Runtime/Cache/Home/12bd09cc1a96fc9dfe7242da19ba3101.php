...
<link href="/share/Public/Home/css/punlish.css" rel="stylesheet" media="all" />
 ...
 <script type="text/javascript" src="/share/Public/Home/ueditor/ueditor.all.min.js"></script>
        ...
        <style type="text/css">
            ...
            <div class="title_p">
            <ul>
            <li ><a href="<?php echo U('User/pshWorksPag');?>">作品发布</a></li>
             <li style="border-top: 3px solid #96424a;background:white;"><a href="<?php echo U('User/pshArtPag');?>">文章发表</a></li>
            </ul>
            </div>
            <form action="<?php echo U('User/pubAritical');?>" id="pubArtical" name="pubArtical" method="POST" enctype="multipart/form-data">

            <div class="punlish_d">
            <table>
            <tr>
                <th style="height:70px;" >文章名称</th>
                <td style="height:70px;"><input maxlength="50" type="text" value="" class="newTxt" name="Articalname">
                <span>最多只能输入50个字</span></td>
            </tr>
             <tr>
                <th style="height:70px;" >文章分类</th>
                <td style="height:70px;">
                <select name="fenlei" style="font-size:14px;font-family:幼圆;color:#666">
                    <option value="JC">原创教程</option>
                    <option value="GD">观点/经验</option>
                    <option value="SJ">设计资讯/资料</option>
                    <option value="OTHERS">其他</option>
                </select>
                </td>
            </tr>
            <tr>
                <th style="height:70px;vertical-align: top;padding-top:22px;" >文章内容</th>
                <td style="height:70px; padding:20px 25px;">
                	<script type="text/plain" id="content" style="width:900px;height:500px;"></script>
                	<!--<script id="editor" name="ArticalContent" type="text/plain" style="width:900px;height:500px;"></script>-->
                	<!--<textarea name="ArticalContent" class="newArea " placeholder="正文内容"></textarea>-->
               </td>
            </tr>
            <!--<tr>
                <th style="height:70px;" >上传图片</th>
                <td style="height:70px;"><input  type="file" name="ArticalImg" style="cursor: pointer; opacity:100;height:20px;"/>
                <span style="width:400px;font-size:14px;">支持jpg/gif/png格式,</span></td>
            </tr>-->
            <input type="hidden" value="2" class="newTxt" name="upLoadType">
            </table>

            <div class="Punlish"><input type="button" id="fsub" name="" value="发布" placeholder=""></div>
            </div>
            </form>
...
<script type="text/javascript">
    ...
    toolbars:[  ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace', 'help', 'drafts']  ],//自定义ueditor工具栏
  ...
  editor.render("content");
			...
			window.onload = function(){
				...
				document.getElementById('fsub').onclick=function(){
					document.getElementById('pubArtical').submit();
				};
			}
