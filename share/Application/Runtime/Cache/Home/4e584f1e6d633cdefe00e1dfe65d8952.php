    ...
    <div class="dynamic">
        ...
        <div class="background_middle">
            ...
            <?php if(is_array($WorksMain)): $i = 0; $__LIST__ = $WorksMain;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="content2">
                    <?php if(empty($userTX)): ?><div class="author">
                            <img src="/share/Public/Home/image/index/person_1.png" width="100px" height="100px"
                                 style="border-radius: 90px;border:4px solid white"/>
                        </div>
                        <?php else: ?>
                        <div class="author">
                            <a href="/share/index.php/Home/user/personone/id/<?php echo ($vo["userid"]); ?>"><img src="/share/Public<?php echo ($userTX); ?>" width="100px" height="100px"
        ...
        <div class="view_more">
            ...
            <div class="view_others">
                <!--<?php dump($comment); ?>-->
                <?php if(is_array($comment)): $i = 0; $__LIST__ = $comment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$com): $mod = ($i % 2 );++$i;?><div class="other" style="border-bottom:1px solid gray;">
                        <div class="view_top">
            ...
            function addcomment() {
                ...
                if ($("#content").val() == "") {
                    ...
                    $.ajax({
                        ...
                        dataType: "json", //数据的格式 建议大家使用json格式
                        data: comment,
                        url: "/share/index.php/Home/Works/addcomment", //请求的url地址
