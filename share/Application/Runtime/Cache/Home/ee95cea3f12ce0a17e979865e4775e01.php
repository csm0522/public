			...
			<div class="layer_right" style="margin-bottom:180px;">
				...
				<div class="r_1" id="box1" style="display:block;margin-top:0">
					...
					<div class="r_form">
						...
						<div class="f_right">
							<input type="radio" id="nan" checked="checked" name="Sex" value="male" style="margin-left:5px;margin-right:5px;"/><label for="nan">男</label>
							<input type="radio" id="nv" name="Sex" value="female" style="margin-left:5px;margin-right:5px;"/><label for="nv">女</label>
							<input type="radio" id="null" name="Sex" value="null" style="margin-left:5px;margin-right:5px;"/><label for="null">不告诉你</label>
						</div>
					</div>
					<div class="r_form">
					...
					<div class="r_form">
						...
						<div class="f_right">
							<img src="/share/Public/Home/image/index/user.png" weight="30px" height="30px" />
