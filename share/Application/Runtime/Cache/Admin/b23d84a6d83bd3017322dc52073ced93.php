	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<th style="width:80px;;text-align: center;">举报状态</th>
		...
		<tbody>
			<?php if(is_array($list)): foreach($list as $k=>$C): ?><tr>
					...
					<td>
						<?php if($C['reptag'] == 2 ): ?><label class="btn btn-primary" type="button" style="background: red;border:none;color:white;width: 82px;margin-bottom: 4px;">被举报</label>
							<a href="/share/index.php/Home/Works/works/id/<?php echo ($C["ariticalid"]); ?>" class="primary" target="_blank" ><button class="btn btn-primary" type="button"style="border:none;background: pink;margin-bottom: 4px;color:white;width: 82px;">查看</button></a>
							<a href="/share/index.php/Admin/Works/unRepWorks/id/<?php echo ($C["ariticalid"]); ?>" class="primary" ><button class="btn btn-primary" type="button"style="border:none;background:orangered;color:white;width: 82px;">取消</button></a>
							<?php elseif($C['reptag'] == 0 ): ?><button class="btn btn-primary" type="button"style="background: green;color:white;width: 82px;">通过</button><?php endif; ?>
					...
					<td>
						<?php if($C['status'] == 0 ): ?><label class="btn btn-primary" type="button" style="background: black;color:white;width: 82px;">已删除</label>

							<a href="/share/index.php/Admin/Works/unDeleWorks/id/<?php echo ($C["ariticalid"]); ?>" class="primary" ><button class="btn btn-primary" type="button"style="background: orange;color:white;width: 82px;">解除</button></a>
							<?php elseif($C['status'] == 1 ): ?> <a href="/share/index.php/Admin/Works/deleWorks/id/<?php echo ($C["ariticalid"]); ?>" class="primary" ><button class="btn btn-primary" type="button">删除文章</button></a><?php endif; ?>
					</td>
