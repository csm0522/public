    ...
    <div class="row" style="margin-left:0;">
        ...
        <div class="col-lg-3" style="width: 25%;margin-bottom:10px;">
            <div class="panel panel-danger">
                ...
                <a href="<?php echo U('Works/essaysList');?>">
		...
		<div class="alert alert-success" role="alert" style="width: 70%;">最后登陆时间:&nbsp;<span style="color:black;"><?php echo ($adminInfo["lastdate"]); ?></span></div>
		<div class="alert alert-info" role="alert" style="width: 50%;">最后登陆IP:&nbsp;<span style="color:black;"><?php echo ($adminInfo["lastip"]); ?></span></div>
		<div class="alert alert-warning" role="alert" style="width: 30%;">登陆次数:&nbsp;<span style="color:black;"><?php echo ($adminInfo["loginnum"]); ?></span></div>
